...
@Suppress("unused")
fun HttpServer.enableCORSGlobal(corsHost: String, allowCredentials: Boolean = false): HttpServer {
...
fun HttpServer.controllers(vararg args: KClass<*>): HttpServer {
    ...
    val optionsPaths = mutableListOf<String>()
    args.forEach { kClass ->
